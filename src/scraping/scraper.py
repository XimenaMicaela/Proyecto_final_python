...
def fetch_page(url):
    ...
    if response.status_code == 200: # Comparamos el status code con el 200 que significa que fue una petición exitosa
        return response.content # Devolvemos el contenido de la página si la solicitud fue exitosa
    else:
